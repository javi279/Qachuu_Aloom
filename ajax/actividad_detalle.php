...
$team_id = isset($_POST["team_id"]) ? limpiarCadena($_POST["team_id"]) : ""; // Capturamos el ID del equipo
...
switch ($_GET["op"]) {
    ...
    case 'listarNoAsignados':
        $idactividad = isset($_POST['idactividad']) ? limpiarCadena($_POST['idactividad']) : "";
        $team_id = isset($_POST['team_id']) ? limpiarCadena($_POST['team_id']) : ""; // Capturamos el team_id
